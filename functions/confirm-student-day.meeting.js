// GET  /confirm-student-day?weekStartDate=YYYY-MM-DD
// POST /confirm-student-day { weekStartDate }
...
module.exports = function (app) {
  ...
  app.get('/confirm-student-day', async (req, res) => {
    try {
  ...
  app.post('/confirm-student-day', async (req, res) => {
    try {
      const ctx = await getAuth(req, res);
      if (!ctx) return;
      const { supabase, myEmail } = ctx;
